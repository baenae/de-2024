<template>
	<main>
		...
		<p>
			...
			<a target="_blank" href="https://www.bfdi.bund.de/">https://www.bfdi.bund.de/</a>.
		</p>

		<h3>Recht auf Datenübertragbarkeit</h3>
		<p>
			Ihnen steht das Recht zu, Daten,
			die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten,
		...
		<p>
			...
			Sperrung oder Löschung dieser Daten. Diesbezüglich und auch zu weiteren Fragen zum Thema personenbezogene
		...
		<h3>Besuchte Seite auf unserer Domain</h3>
		<ul>
		...
		<p>
			Mein-Datenschutzbeauftragter.de stellt den Konfigurator für die individuelle Nutzung
			kostenlos zur Verfügung. Deshalb bitten wir Sie, den Hinweis auf unseren Dienst nicht
			aus dem Muster zu entfernen.
			Es ist zudem nicht gestattet, den Konfigurator als Kopie auf der eigenen Homepage
